...
module.exports = async (pluginConfig, { logger }) => {
  ...
  try {
    ...
    await execa.shell(
      'chmod +x /home/travis/build/tandfgroup/kai/node_modules/semantic-release-gcr/scripts/gcloudlogin.sh',
      { stdio: 'inherit' }
    )
    await execa.shell('/home/travis/build/tandfgroup/kai/node_modules/semantic-release-gcr/scripts/gcloudlogin.sh', {
      stdio: 'inherit',
    })
  } catch (err) {
    console.log(err)
